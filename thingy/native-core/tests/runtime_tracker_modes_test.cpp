...
int main()
{
            ...
            RuntimeTrackerEngineSettings::TrackingMode::Tracking3})
    {
        ...
        (void)engine.Tick(MakeInput(1200, false, true, true));
        (void)engine.Tick(MakeInput(1500, false, true, false));
        (void)engine.Tick(MakeInput(1800, false, true, false));
        auto r = engine.Tick(MakeInput(2000, false, true, false));
