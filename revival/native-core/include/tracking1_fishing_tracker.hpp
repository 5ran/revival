...
{
class Tracking1FishingTracker : public IFishingTracker
{
public:
    explicit Tracking1FishingTracker(RuntimeTrackerEngine* engine) : engine_(engine) {}
    FishingTrackerMode Mode() const override { return FishingTrackerMode::Tracking1; }
    ...
    FishingTrackerStatus GetStatus() const override { return FishingTrackerStatus{running_, "RUNNING", running_ ? "Tracking1 active." : "Tracking1 stopped.", std::nullopt, false}; }
