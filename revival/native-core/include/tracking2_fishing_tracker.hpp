...
{
class Tracking2FishingTracker : public IFishingTracker
{
public:
    explicit Tracking2FishingTracker(RuntimeTrackerEngine* engine) : engine_(engine) {}
    FishingTrackerMode Mode() const override { return FishingTrackerMode::Tracking2; }
    ...
    FishingTrackerStatus GetStatus() const override { return FishingTrackerStatus{running_, "RUNNING", running_ ? "Tracking2 active." : "Tracking2 stopped.", std::nullopt, false}; }
