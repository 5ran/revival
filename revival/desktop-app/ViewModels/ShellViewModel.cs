...
public sealed partial class ShellViewModel : ObservableObject
{
    ...
    private readonly TrackingOverlayService trackingOverlay = new();
    ...
    public ShellViewModel(IMacroIpcClient ipcClient)
    {
        ...
        TrackerModes = ["Hybrid", "Spam", "Predict"];
        ...
        trackingOverlay.SetTrackingMode(SelectedTrackerMode);
        trackingOverlay.Start();

        statusTimer = new DispatcherTimer { Interval = TimeSpan.FromMilliseconds(120) };
    ...
    private string committedHotkeyText = "F6";

    [ObservableProperty]
    private string selectedTrackerMode = "Hybrid";
    ...
    [ObservableProperty]
    private string inputStatusText = "Idle";
    ...
    {
        trackingOverlay.SetTrackingMode(value);
    ...
    [RelayCommand]
    private async Task ToggleMacroAsync()
    {
        if (IsRunning)
        {
    ...
    private void ApplyStatus(JsonElement root)
    {
        ...
        try
        {
            ...
            ApplyString(root, "InputStatus", value => InputStatusText = value);
            ...
            ApplyString(root, "Caught", value => CaughtText = value);
    ...
    private void ApplyStats(JsonElement root)
    {
        ...
        try
        {
            ...
            ApplyString(root, "currentFish", value => CurrentFishText = value);
            ApplyString(root, "progress", value => ProgressText = value);
            ApplyString(root, "input", value => InputStatusText = value);
            ApplyString(root, "equippedRod", value => EquippedRodText = value);
            ApplyString(root, "currentEnchant", value => CurrentEnchantText = value);
            ApplyString(root, "appraiseStatus", value => AppraiseStatusText = value);
            ApplyString(root, "appraiseHeldFish", value => AppraiseHeldFishText = value);
