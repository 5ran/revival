...
public sealed class FishingViewModel : ViewModelBase
{
    ...
    {
        AppLog.Fishing("FlowVM", $"StartAsync requested | running={IsRunning} phase={Phase} autoAquarium={AutoAquariumEnabled}");
    ...
    {
        AppLog.Fishing("FlowVM", $"StopAsync requested | running={IsRunning} phase={Phase} autoAquarium={AutoAquariumEnabled}");
