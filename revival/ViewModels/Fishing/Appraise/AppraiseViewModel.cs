...
public sealed class AppraiseViewModel : ViewModelBase
{
    ...
    {
        AppLog.Info("MacroMode", "Appraise StartAsync requested.");
        AutoAppraiseEnabled = true;
        _runner.Reset();
        _rollingDotStep = 0;
        IsRunning = true;
        StatusText = "Rolling";
        AppLog.Info("MacroMode", $"Appraise started. rollMode={_rollMode}");
        return Task.CompletedTask;
    }

    public Task StopAsync()
    {
        AppLog.Info("MacroMode", "Appraise StopAsync requested.");
        IsRunning = false;
        _runner.Reset();
        StatusText = "---";
        AppLog.Info("MacroMode", "Appraise stopped.");
        return Task.CompletedTask;
    }
