...
internal static class NativeKeyboard
{
    ...
    public static void PressCtrlV(IntPtr targetWindow)
    {
        PressModifiedKey(VkV, targetWindow, control: true, shift: false, alt: false);
    }
        ...
        for (var attempt = 0; attempt < 3; attempt++)
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    Marshal.WriteInt16(target, chars.Length * sizeof(char), 0);
                }
                finally
                {
                    GlobalUnlock(handle);
    ...
    public static bool PasteText(string text, IntPtr targetWindow)
    {
