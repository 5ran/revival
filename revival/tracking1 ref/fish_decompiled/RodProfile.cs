...
internal abstract class RodProfile
{
    ...
    // Optional keepalive for held input. Used by the default rod to reassert
    // the down state if the game misses a press.
    public virtual int FishingHoldRefreshMs => 0;
